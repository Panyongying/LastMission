...
<main role="main" class="responsive my-hm">
		...
		<nav class="section navigation menu " role="navigation">
			<ul role="menu">
				<li class="item" role="presentation" tabindex="0">
						<a href="/xxoooo/Project/project/index.php/Home/User/person" role="menuitem">
							概览</a>
					</li>
				...
				<li class="item" role="presentation" tabindex="-1">
						<a href="/xxoooo/Project/project/index.php/Home/User/addAddress" role="menuitem">
							地址簿</a>
					</li>
				<li class="item" role="presentation" tabindex="-1">
	...
	<div class="layout layout-eight"id="profileDIV">
	    ...
	    <form class="form-section agile-form" id="profile">
	        ...
	        <div class="button-group">
                ...
                <a href="/xxoooo/Project/project/index.php/Home/User/updatePassword" class="button change-password">更改密码</a>
	...
	<script>
		...
		$('#saveProfileDetails').click(function () {
			...
			$.post('/xxoooo/Project/project/index.php/Home/User/account', {
				'id':<?php echo ($list['id']); ?>,
