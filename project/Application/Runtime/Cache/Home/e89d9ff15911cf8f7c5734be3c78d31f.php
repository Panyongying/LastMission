...
<main role="main" class="responsive my-hm">
	...
	<div class="layout layout-eight"id="profileDIV">
	    ...
	    <form class="form-section agile-form" id="profile">
	        ...
	        <div class="button-group">
                ...
                <a href="/2nd Project/04.21/project/index.php/Home/User/updatePassword" class="button change-password">更改密码</a>
	...
	<script>
		...
		$('#saveProfileDetails').click(function () {
			...
			$.post('/2nd Project/04.21/project/index.php/Home/User/account', {
				'id':<?php echo ($list['id']); ?>,
