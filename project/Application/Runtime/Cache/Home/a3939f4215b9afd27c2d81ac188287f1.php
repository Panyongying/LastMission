...
<div class="order-tracking">
	...
	<form method="post" class="checkout-place-order-section ng-pristine ng-valid" ng-submit="paymentCtrl.doPayment(&#39;54365404&#39;)">
		...
		<ul class="item-list">
			<li class="item-list-item"><a href="/2nd Project/04.21/project/index.php/Home/User/orders">我的订单</a></li>
			<li class="item-list-item"><a href="/2nd Project/04.21/project/index.php/Home/CustomService/index">客户服务</a></li>
		</ul>
	</form>
	...
	<div class="product-detail-list-item-image-wrapper">
		<div class="wrapper-inner">
			<a href="/2nd Project/04.21/project/index.php/Home/Index/goodsDetail/id/<?php echo ($ov["gid"]); ?>">
...
<li class="item order-total">
	...
	<script>
		$('#checkoutViewPaymentButton').click(function () {
			...
			$.post(
				'/2nd Project/04.21/project/index.php/Home/Order/pay',
				{
				...
				function (data) {
					if (data == 2) {
						...
						location.href = '/2nd Project/04.21/project/index.php/Home/Order/thinkYou';
					}
				},
				'json'
			);
