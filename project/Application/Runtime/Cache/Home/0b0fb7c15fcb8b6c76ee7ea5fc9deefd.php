...
<!-- HeaderLife -->
    ...
    <main role="main" class="responsive segments"><!-- Main -->
          ...
          <!--   <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner" role="listbox" style="height:336px">
                <div class="item active">
                  <img src="/2nd Project/04.19/project/Public/<?php echo ($goodsList[0]["pic"]); ?>" alt="...">
                  <div class="carousel-caption">
                    ...
                  </div>
                </div>
                <div class="item">
                  <img src="/2nd Project/04.19/project/Public/<?php echo ($goodsList[1]["pic"]); ?>" alt="...">
                  <div class="carousel-caption">
                    ...
                  </div>
                </div>
                <div class="item">
                  <img src="/2nd Project/04.19/project/Public/<?php echo ($goodsList[2]["pic"]); ?>" alt="...">
                  <div class="carousel-caption">
                    ...
                  </div>
                </div>
        ...
        <img src="./时尚女装——潮流购物 _ H&M CN_files/hmprod(10)"></div>
        	...
        	<img src="/2nd Project/04.19/project/Public/<?php echo ($goodsList[4]["pic"]); ?>"></div>
