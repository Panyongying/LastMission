...
<!-- HeaderLife -->
    ...
    <main role="main" class="responsive segments"><!-- Main -->
          ...
          <!--   <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner" role="listbox" style="height:336px">
                <div class="item active">
                  <img src="/last/LastMission/project/Public/<?php echo ($goodsList[0]["pic"]); ?>" alt="...">
                  <div class="carousel-caption">
                    ...
                  </div>
                </div>
                <div class="item">
                  <img src="/last/LastMission/project/Public/<?php echo ($goodsList[1]["pic"]); ?>" alt="...">
                  <div class="carousel-caption">
                    ...
                  </div>
                </div>
                <div class="item">
                  <img src="/last/LastMission/project/Public/<?php echo ($goodsList[2]["pic"]); ?>" alt="...">
                  <div class="carousel-caption">
                    ...
                  </div>
                </div>
            ...
            <section class="segment section">
            	...
            	<div class="two modules">
            		...
            		<article class="default-m-serif has-effect-1 teaser-media  single-cta" data-item-ratio="2x3" style="position:relative;" data-view-tracking="true" data-activity-type="CAMPAIGN" data-activity-code="8NF" data-promotion-creative="8NF Teaser Page"><a href="" target="_self" class="hidden-text cta-overlay" style="background:url('/last/LastMission/project/Public/<?php echo ($goodsList[2]["pic"]); ?>')">即刻选购</a>
            	<div class="background-image teaser-image rimd">
        ...
        <img src="./时尚女装——潮流购物 _ H&M CN_files/hmprod(10)"></div>
        	...
        	<img src="/last/LastMission/project/Public/<?php echo ($goodsList[5]["pic"]); ?>"></div>
