...
<!-- HeaderLife -->
    ...
    <img src="/last/LastMission/project/Public/Search/user" width="1" height="1" style="position: absolute; left: -999px">
...
<div class="row">
   ...
   <div class="col-12">
       <div class="product-list-title"></div>
           ...
           <div class="row">
               <div class="product-filters sticky-on-scroll" style="width:100%" data-sticky-stop-offset="24" data-sticky-fill="true">
                   <div class="row">
                       <div class="totop">
                           <a href="#" class="toptrigger">返回到顶部</a> <a href="/last/LastMission/project/index.php/Home/Index/index" style="background:url('/last/LastMission/project/Public/show/logotype.png');background-size:100%;" class="filterlogo">返回到开始</a>
                       </div>
                       <div class="filteractions clearfix">
                           <ul class="triggers clearfix">
                               ...
                               <li class="js-clickexpand clickexpand filter" style="border-right:1px solid #d1d1d1" data-expandoptions="{&quot;toggle&quot;:&quot;true&quot;}">
                                ...
                                <form id="option-form1" action="/last/LastMission/project/index.php/Home/Index/goodsFilter" method="get" >
                                    ...
                                    <div class="cols clearfix">
                                                ...
                                                //ajax筛选
                                                    $('.choose-input').on('click', function() {
                                                        ...
                                                        data1 = JSON.stringify(postData);
                                                        //ajax
                                                        $.ajax({
                                                          type:'post',
                                                          url:'/last/LastMission/project/index.php/Home/Index/goodsFilter',
                                                          data:'data=' + data1,
                                      ...
                                      $('input[name="choose-radio"]').on('click', function() {
                                        ...
                                        if ($(this).prop('checked')) {
                                          postData.orderBy = $(this).attr('data-value');
                                            ...
                                            data2 = data1 || JSON.stringify(postData);
                                                        //ajax
                                                        $.ajax({
                                                          type:'post',
                                                          url:'/last/LastMission/project/index.php/Home/Index/goodsFilter',
   ...
   <p class="text">
                       ...
                       <div class="grid col-6">
                           <ul>
                               ...
                               共 <span class="total-count"><?php echo ($lastCount); ?></span> 商品
                                ...
                                <!-- <strong>
                                筛选结果：共1,066项，其中筛选出<span class="total-count">1066</span>项
                               </strong> -->
                               </span>
      ...
      <?php if(is_array($res)): foreach($res as $key=>$v): ?><section class="product-items productlist-row">
        ...
        <div class="product-items-content">
          <div class="row">
							...
							<div class="grid col-3">
								...
								<article class="product-item club-price-item" data-articlecode="0453424002" onclick="setVCParameter(&#39;SEARCH&#39;,&#39;0453424002&#39;); setNotificationTicket(&#39;Oy9zZWFyY2gvc2VhcmNoLWhpdHMtd2l0aC1jb3VudC9zZWFyY2gtaGl0czsjO3Byb2R1Y3Rfa2V5OzA0NTM0MjRfZ3JvdXBfMDAyX3poX2NuOzA0NTM0MjQwMDJfemhfY247OyM7NTc7&#39;,&#39;0453424002&#39;); setOsaParameters(utag_data.category_id,&#39;SMALL&#39;,&#39;0453424002&#39;);">
									<!-- Product item -->
											...
											<a href="/last/LastMission/project/index.php/Home/Index/goodsDetail/id/<?php echo ($v->id); ?>" title="<?php echo ($v->name); ?>" class="product-item-link"> <img width="222" height="333" src="" class="goodsId" data-id="<?php echo ($v->id); ?>" class="product-item-image" alt="<?php echo ($v->name); ?> " data-alttext="<?php echo ($v->name); ?> 模特款型" title="<?php echo ($v->name); ?> ">
													...
													<!-- <div class="marker ">
														<img class="marker-image" data-legal-text="优惠适用于hm.com,截至2017年4月18日17:00 " alt="优惠适用于hm.com,截至2017年4月18日17:00 " src="/last/LastMission/project/Public/Search/off-10-black-ZH-CN.png" title="优惠适用于hm.com,截至2017年4月18日17:00 ">
													</div> -->
							...
							<!-- /Product item --><?php endforeach; endif; ?>
    ...
    <script>
      ...
      if ( scrollTop + browserHeight  >= documentHeight - 300) {
        ...
        $.ajax({
          url:'/last/LastMission/project/index.php/Home/Index/getGoods?data=' + data3,
          beforeSend:function(){
            if (ajaxing) {
              return false;
            }
            ajaxing = true;
            $('#ajax-loading').append('<img id="ajax-pic" style="margin-left:46%" src="/last/LastMission/project/Public/show/ajax-loader.gif" alt="">');
          },
          success:function(data) {
            ajaxing = false;
                      var data = JSON.parse(data);
                      ...
                      if (data == '') {
                        ...
                        $('.goodsId').each(function(i) {
                          ...
                          var that = $(this);
                          $.ajax({
                            url:'/last/LastMission/project/index.php/Home/Index/ajaxGetGoodsPic/id/' + id,
                            beforeSend:function(){
                              that.attr('src', '/last/LastMission/project/Public/show/ajax-loader.gif');
                            },
                            success:function(data){

                              that.attr('src', '/last/LastMission/project/Public/'+data);
                            },
                          })
                        });
                    }
        ...
        <script>
          ...
          //ajax筛选
              $('.choose-input').on('click', function() {
                  ...
                  $.ajax({
                    type:'post',
                    url:'/last/LastMission/project/index.php/Home/Index/getGoods',
                    data:'data=' + data1,
                    beforeSend:function(){
                      $('#ajax-loading').append('<img id="ajax-pic" style="margin-left:46%" src="/last/LastMission/project/Public/show/ajax-loader.gif" alt="">');
                    },
