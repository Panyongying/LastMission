       ...
       <div class="product-list-title"></div>
           ...
           <div class="row">
               <div class="product-filters sticky-on-scroll" style="width:100%" data-sticky-stop-offset="24" data-sticky-fill="true">
                   <div class="row">
                       <div class="totop">
                           <a href="#" class="toptrigger">返回到顶部</a> <a href="/Project/project/index.php/Home/Index/index" style="background:url('/Project/project/Public/show/logotype.png');background-size:100%;" class="filterlogo">返回到开始</a>
                       </div>
                       <div class="filteractions clearfix">
                           <ul class="triggers clearfix">
                               ...
                               <li class="js-clickexpand clickexpand filter" style="border-right:1px solid #d1d1d1" data-expandoptions="{&quot;toggle&quot;:&quot;true&quot;}">
                                ...
                                <form id="option-form1" action="/Project/project/index.php/Home/Index/goodsFilter" method="get" >
                                    ...
                                    <div class="cols clearfix">
                                                ...
                                                //ajax筛选
                                                    $('.choose-input').on('click', function() {
                                                        ...
                                                        $.ajax({
                                                          type:'post',
                                                          url:'/Project/project/index.php/Home/Index/goodsFilter',
                                                          data:'data=' + data1,
