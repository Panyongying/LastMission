        	                          ...
        	                          <div class="section-menu-category">
        	                              ...
        	                              <ul style="display: block;">
                                                <?php if(is_array($twoList)): foreach($twoList as $key=>$v): ?><li class="section-menu-subdepartment" style="padding:5px 0px">
        	                                           <a href="/2nd Project/04.19/project/index.php/Home/Index/goodsList/tid/<?php echo ($v["id"]); ?>/pid/<?php echo ($pid); ?>">
        	                                               <?php echo ($v["name"]); ?>
        	                                           </a>
...
<!--                     <div class="totop">
            ...
            <div class="row">
                <?php if(is_array($lists)): foreach($lists as $key=>$vv): ?><div class="col-3" style="float:left;margin-left:12px">
                    ...
                    <article class="product-item club-price-item" data-articlecode="0481148009" onclick="setOsaParameters(utag_data.category_id,'SMALL', '0481148009'); setNotificationTicket('Oy9wbHAvcHJvZHVjdC1saXN0LXdpdGgtY291bnQvcHJvZHVjdC1saXN0OyM7cHJvZHVjdF9rZXk7MDQ4MTE0OF96aF9jbjswNDgxMTQ4MDEwX3poX2NuOzsjOzU7','0481148009');">
                        <a href="/2nd Project/04.19/project/index.php/Home/Index/goodsDetail/id/<?php echo ($vv["id"]); ?>" title="<?php echo ($vv["name"]); ?>" class="product-item-link"> <img width="222" height="333" src="/2nd Project/04.19/project/Public/<?php echo ($vv[pic][0]); ?>" class="product-item-image" alt="<?php echo ($vv["name"]); ?> 模特款型"title="<?php echo ($vv["name"]); ?> 模特款型">
        ...
        <script>
            ...
            $('.js-favorite').click( function () {
                ...
                $.post('/2nd Project/04.19/project/index.php/Home/Favorite/addFavorite',{
                    ...
                    if (data == 0) {
                       ...
                       show_msg('请先登录');
                        ...
                        setTimeout(function () {
                           ...
                           window.location.href="/2nd Project/04.19/project/index.php/Home/User/signIn";
        ...
        //点亮收藏的星
            $.post('/2nd Project/04.19/project/index.php/Home/Favorite/checkedFavorite', {}, function (data){
