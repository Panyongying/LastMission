        	                          ...
        	                          <div class="section-menu-category">
        	                              ...
        	                              <ul style="display: block;">
                                                <?php if(is_array($twoList)): foreach($twoList as $key=>$v): ?><li class="section-menu-subdepartment" style="padding:5px 0px">
        	                                           <a href="/last/LastMission/project/index.php/Home/Index/goodsList/tid/<?php echo ($v["id"]); ?>/pid/<?php echo ($pid); ?>">
        	                                               <?php echo ($v["name"]); ?>
        	                                           </a>
...
<!--                     <div class="totop">
            ...
            <div class="row" id="appendData">
                <?php if(is_array($lists)): foreach($lists as $key=>$vv): ?><div class="col-3" style="float:left;margin-left:12px">
                    ...
                    <article class="product-item club-price-item" data-articlecode="0481148009" onclick="setOsaParameters(utag_data.category_id,'SMALL', '0481148009'); setNotificationTicket('Oy9wbHAvcHJvZHVjdC1saXN0LXdpdGgtY291bnQvcHJvZHVjdC1saXN0OyM7cHJvZHVjdF9rZXk7MDQ4MTE0OF96aF9jbjswNDgxMTQ4MDEwX3poX2NuOzsjOzU7','0481148009');">
                        <a href="/last/LastMission/project/index.php/Home/Index/goodsDetail/id/<?php echo ($vv["id"]); ?>" title="<?php echo ($vv["name"]); ?>" class="product-item-link"> <img width="222" height="333" src="/last/LastMission/project/Public/<?php echo ($vv[pic][0]); ?>" class="product-item-image" alt="<?php echo ($vv["name"]); ?> 模特款型"title="<?php echo ($vv["name"]); ?> 模特款型">
        ...
        //点亮收藏的星
            ...
            $(window).on('scroll', function() {
                ...
                var url = '/last/LastMission/project/index.php/Home/Index/ajaxGetData';
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            for (var i=0; i<len; i++) {
                                ...
                                res += '<div class="col-3" style="float:left;margin-left:12px"><article class="product-item club-price-item"><a href="/last/LastMission/project/index.php/Home/Index/goodsDetail/id/'+data[i].id+'" title="'+data[i].name+'" class="product-item-link"> <img width="222" height="333" src="/last/LastMission/project/Public/'+data[i].pic[0]+'" class="product-item-image" alt="'+data[i].name+' 模特款型"title="<?php echo ($vv["name"]); ?> 模特款型"><button type="button" class="favorite icon icon-favorites js-favorite " value="<?php echo ($vv["id"]); ?>">加入收藏</button></a><div class="product-item-details"><h3 class="product-item-heading"><a href="/zh_cn/productpage.0481148009.html">'+data[i].name+'</a></h3><strong class="price">¥ '+data[i].price+' </strong><div class="product-item-selection">新品</div></div></article></div>';
