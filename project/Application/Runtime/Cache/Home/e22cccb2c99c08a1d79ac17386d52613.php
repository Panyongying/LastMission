    	  ...
    	  <div class="layout layout-eight">
    		<div class="grid col-7">
    			...
    			<div class="grid col-4">
    	           <div class="login-form new-user">
        		      <h3>老客户</h3>
                		...
                		<form id="signinForm" class="responsive half-size" action="/2nd Project/04.19/project/index.php/Home/User/login" method="post">
                ...
                <label for="txt-signin-email" class="label">电子邮箱</label><input id="txt-signin-email" name="username"  type="email"></div>
                			...
                			<a href="/2nd Project/04.19/project/index.php/Home/User/forgetPassword"class="forgotten-password underline">忘了密码？</a>
                    ...
                    <div class="grid col-3">
        					...
        					<p>
        						创建新账户，让购物更简便。</p>
        					<a href="/2nd Project/04.19/project/index.php/Home/User/signUp"><button class="button button-secondary">加入我们</button></a>
