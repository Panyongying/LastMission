            ...
            <nav class="session-menu"><!-- Session menu -->
                ...
                <div class="autosuggestsearch parbase">
                    <div id="search-field" class="ui-widget">
                        ...
                        <form method="get" action="/xxoooo/Project/project/index.php/Home/User/searchGoods" class="ng-pristine ng-valid">
...
<!-- 	// <script src="/xxoooo/Project/project/Public/address/distpicker.data.js"></script>
	// <script src="/xxoooo/Project/project/Public/address/distpicker.js"></script>
	// <script src="/xxoooo/Project/project/Public/address/main.js"></script> -->
		...
		<nav class="section navigation menu " role="navigation">
			<ul role="menu">
				<li class="item" role="presentation" tabindex="0">
					<a href="/xxoooo/Project/project/index.php/Home/User/person" role="menuitem">概览</a>				
				</li>
				<li class="item" role="presentation" tabindex="-1">
					<a href="/xxoooo/Project/project/index.php/Home/User/account" role="menuitem">个人信息</a>
	...
	<script>
		...
		$('#saveInfo').click(function () {
			...
			$.post('/xxoooo/Project/project/index.php/Home/User/addAddress', {
        ...
        <script>
            ...
            $('.lists').on('mouseover', function() {
                ...
                var url = '/xxoooo/Project/project/index.php/Home/User/base';
