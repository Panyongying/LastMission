		...
		<div class="grid col-4">
			<div class="box-content">
				<div class="login-form">
					...
					<h3>
						登录</h3>
					<form id="mainLoginForm" action="/2nd Project/04.19/project/index.php/Home/Order/checkoutLogin" method="post"  class="ng-pristine ng-valid"><input type="hidden" id="targetURL" name="targetURL" value="/login/checkout">
...
<div style="display: none" id="hidden_register_box" class="box">
	...
	<div class="box-content">
		...
		<!-- Login form -->
			...
			<form action="<?php echo U('User/register');?>" method="post" class="responsive form-section ng-pristine ng-valid ng-valid-email ng-valid-maxlength" id="registration-form">
...
<div class="box checkout-order" id="checkoutOrderPartDiv">
	...
	<?php if(is_array($data["cartList"])): foreach($data["cartList"] as $key=>$ov): ?><li class="checkout-order-item">
			
				<img src="./Proceed to Checkout _ H&amp;M China_files/hmprod-set=source[%2Fmodel%2F2016%2FE00+0438740+001+74+1904.jpg],type[STILLLIFE_FRONT]&amp;hmver=1&amp;call=url[file-%2Fproduct%2Forder]" alt="<?php echo ($ov["name"]); ?>" title="<?php echo ($ov["name"]); ?>" class="checkout-order-item-image">
			

				<div class="checkout-order-item-product-info">
					<div class="product-item-headline"><?php echo ($ov["name"]); ?></div>
