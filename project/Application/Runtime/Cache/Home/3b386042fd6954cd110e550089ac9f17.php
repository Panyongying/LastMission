...
<!-- HeaderLife -->
				...
				<nav class="section navigation menu " role="navigation">
					<ul role="menu">
						...
						<li class="item" role="presentation" tabindex="-1">
							<a href="/2nd Project/04.19/project/index.php/Home/User/account" role="menuitem">个人信息</a>					
						</li>
						<li class="item" role="presentation" tabindex="-1">
							<a href="/2nd Project/04.19/project/index.php/Home/User/orders" role="menuitem">订单</a>
					
						</li>
						<li class="item" role="presentation" tabindex="-1">
							<a href="/2nd Project/04.19/project/index.php/Home/User/addAddress" role="menuitem">地址簿</a>
						</li>
				...
				<div class="layout" ng-controller="MyOverviewController">
					<div class="modules sidebarpluscontent">
						...
						<section class="responsive club-user">
							...
							<a href="/2nd Project/04.19/project/index.php/Home/User/account" id="personal-details-title-link"
						...
						<div>
							...
							<section class="responsive orders-summary">
								<header class="module-heading ">
									...
									<a href="/2nd Project/04.19/project/index.php/Home/User/orders" class="view-all link" title="View all orders">查看所有订单</a>
								</header>
								<div class="module-content">
							...
							<div class="two modules">
								<section class="responsive club-address">
									<header class="module-heading">
										...
										<a href="/2nd Project/04.19/project/index.php/Home/User/addAddress" class="view-all link" id="address-book-title-link" aria-labelledby="address-book-title address-book-title-link"
		...
		<script>
			$('.module-content').click(function () {
				location.href = "/2nd Project/04.19/project/index.php/Home/User/orders";
			});
		</script>
