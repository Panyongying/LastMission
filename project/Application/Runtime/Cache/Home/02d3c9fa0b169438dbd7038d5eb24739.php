...
<header class="checkout-header">
	...
	<li class="item item-current">4. 非常感谢</li>
	</ul></header>
	<div class="row ng-scope" ng-controller="PaymentController as paymentCtrl">
	<article class="search-autocorrect  zero-results">
                   <h1>非常感谢，您包裹正在安排配送！
                   </h1>
                   <div class="search-autocorrect-copy">
                       <p><a href="/2nd Project/04.21/project/index.php/Home/Index/index">继续购物>></a></p>
                   </div>
               </article>
