		...
		<nav class="section navigation menu " role="navigation">
			<ul role="menu">
				<li class="item" role="presentation" tabindex="0">
						<a href="/2nd Project/04.21/project/index.php/Home/User/person" role="menuitem">
							概览</a>
					</li>
				<li class="item" role="presentation" tabindex="-1">
						<a href="/2nd Project/04.21/project/index.php/Home/User/account" role="menuitem">
							个人信息</a>
					</li>
				<li class="current item" role="presentation" tabindex="-1">
						<a href="/2nd Project/04.21/project/index.php/Home/User/orders" role="menuitem">
							订单</a>
					</li>
				<li class="item" role="presentation" tabindex="-1">
						<a href="/2nd Project/04.21/project/index.php/Home/User/addAddress" role="menuitem">
							地址簿</a>
					</li>
			</ul>
		</nav>
...
<?php elseif(($ov["orderstatus"] == 2) AND ($ov["ordersendstatus"] == 3) AND ($ov["com"] == 0)): ?><div class="goToCom" style="color: #dddd26;"><a href="/2nd Project/04.21/project/index.php/Home/Comment/comment/oid/<?php echo ($ov["id"]); ?>" class="goToCom-btn" oid="<?php echo ($ov["id"]); ?>" style="color: #0d0d0d">[去评论]</a>&nbsp;&nbsp;已收货</div>
...
<div class="order-details two modules">
	<?php if($ov["orderstatus"] == 1): ?><h3 class="sub-heading">您的订单已保存，但尚未处理</h3>
		<p class="text">
			...
			<a href="/2nd Project/04.21/project/index.php/Home/User/orders" class="text">
				我的H&amp;M - 订单
			</a>
		</p>
...
<li class="item">
 ...
 <?php if($ov["orderstatus"] == 1): ?><div class="order-tracking">
		...
		<div>	
					...
					<form action="/2nd Project/04.21/project/index.php/Home/Order/queryOrder" class="my-hm-order-pay ng-pristine ng-valid">
...
<script>
	...
	$('.receipt-btn').click(function () {
		...
		$.post(
			"/2nd Project/04.21/project/index.php/Home/Order/receipt",
			{
				id:oid
			},
			function (data) {
				if (data == 'no') {
					...
					that.parent().html('<a href="/2nd Project/04.21/project/index.php/Home/Comment/comment/oid/'+oid+'" class="goToCom-btn" style="color: #0d0d0d">[去评论]</a>&nbsp;&nbsp;已收货');
				}
			},
			'json'
		);
	...
	$(document).on('click', '.goToCom-btn', function () {
		location.href = "/2nd Project/04.21/project/index.php/Home/Comment/comment/oid/" + $(this).attr('oid');
	});
