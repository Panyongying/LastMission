...
<!-- HeaderLife -->
 ...
 <section class="product-detail-images grid col-6 clearfix">
    ...
    <!-- 小图 -->
        <ul>
        <?php if(is_array($goodsDeatil['pic'])): foreach($goodsDeatil['pic'] as $key=>$vp): ?><li class="product-detail-thumbnail"><img alt="" src="/2nd Project/04.19/project/Public/<?php echo ($vp["pic"]); ?>" class="product-detail-thumbnail-image" title=""></li><?php endforeach; endif; ?>
        </ul>
      </div>
    ...
    <!-- 大图 -->
            ...
            <img width="384" height="576" alt="" class="product-detail-main-image-image" src="/2nd Project/04.19/project/Public/<?php echo ($goodsDeatil['pic'][0]["pic"]); ?>" title="">
...
<script>
    ...
    $('.filter-option').on('click', function() {
      ...
      var url = '/2nd Project/04.19/project/index.php/Home/Index/colorPics';
      ...
      $.post(url, {aid:$(this).attr('title'),gid:<?php echo ($goodsDeatil['id']); ?>}, function(data) {
        ...
        for (var i=0; i<data.length; i++) {
          ...
          res += '<li class="product-detail-thumbnail"><img alt="" src="/2nd Project/04.19/project/Public/'+data[i].pic+'" class="product-detail-thumbnail-image" title=""></li>';

        }
        res += '</ul>';

        bigPic = '<img width="384" height="576" alt="" class="product-detail-main-image-image" src="/2nd Project/04.19/project/Public/'+data[0].pic+'" title="">';
    ...
    $('.button-buy').click(function() {
      ...
      if ( !($(this).attr('data-size')) ) {
        ...
        // 添加购物车操作
        $.post(
          '/2nd Project/04.19/project/index.php/Home/cart/addToCart',
          {
