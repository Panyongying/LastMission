...
<!-- HeaderLife -->
 ...
 <section class="product-detail-images grid col-6 clearfix">
    ...
    <!-- 小图 -->
        <ul>
        <?php if(is_array($goodsDeatil['pic'])): foreach($goodsDeatil['pic'] as $key=>$vp): ?><li class="product-detail-thumbnail"><img alt="" src="/last/LastMission/project/Public/<?php echo ($vp["pic"]); ?>" class="product-detail-thumbnail-image" title=""></li><?php endforeach; endif; ?>
        </ul>
      </div>
    ...
    <!-- 大图 -->
            ...
            <img width="384" height="576" alt="" class="product-detail-main-image-image" src="/last/LastMission/project/Public/<?php echo ($goodsDeatil['pic'][0]["pic"]); ?>" title="">
...
<div><h2>评论区：</h2></div>
<?php if(empty($data)): ?>暂无评论
<?php else: ?>
<?php if(is_array($data)): foreach($data as $key=>$vc): ?><div style="width:1000px;border-top:1px solid #ccc;margin-top:20px;padding:10px">
...
<script>
    ...
    $('#colorAid').on('click','.filter-option', function() {
      ...
      var url = '/last/LastMission/project/index.php/Home/Index/colorPics';
      ...
      $.post(url, {aid:$(this).attr('title'),gid:<?php echo ($goodsDeatil['id']); ?>}, function(data) {
        ...
        for (var i=0; i<data['pic'].length; i++) {
          ...
          res += '<li class="product-detail-thumbnail"><img alt="" src="/last/LastMission/project/Public/'+data['pic'][i].pic+'" class="product-detail-thumbnail-image" title=""></li>';

        }
        res += '</ul>';

        bigPic = '<img width="384" height="576" alt="" class="product-detail-main-image-image" src="/last/LastMission/project/Public/'+data['pic'][0].pic+'" title="">';
    ...
    $('.button-buy').click(function() {
      ...
      if ( !($(this).attr('data-size')) ) {
        ...
        // 添加购物车操作
        $.post(
          '/last/LastMission/project/index.php/Home/cart/addToCart',
          {
