...
<fieldset>	
	...
	<p class="text">您可在<a href="/2nd Project/04.19/project/index.php/Home/User/account"> 我的H&amp;M </a>中编辑地址</p>
	<h3>使用现有地址</h3>
...
<script src="/2nd Project/04.19/project/Public/Backstage/js/distpicker.data.js"></script>
<script src="/2nd Project/04.19/project/Public/Backstage/js/distpicker.js"></script>
<script src="/2nd Project/04.19/project/Public/Backstage/js/main.js"></script>
<script>
	...
	$('#ad-btn').click(function () {
		...
		if (flag) {
			...
			$.post(
				'/2nd Project/04.19/project/index.php/Home/order/addAddress',
				{
					recname:recname.val(),
	...
	$('#placeorderbutton').click(function () {
		...
		$.post(
			'/2nd Project/04.19/project/index.php/Home/Order/queryOrder',
			{
			...
			function (data) {
				if (data == 2) {
					...
					location.href = '/2nd Project/04.19/project/index.php/Home/Order/queryOrder/oid/' + data;
				}
			},
			'json'
		);
