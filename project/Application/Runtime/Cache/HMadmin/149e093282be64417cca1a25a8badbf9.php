...
<div class="admin-biaogelist">
    ...
    <div class="fbneirong">
      <form class="Forms am-form" action="/last/LastMission/project/index.php/HMadmin/Goods/goodsEdit" method="post">
        ...
        <div class="am-form-group am-cf">
          ...
          <div class="you" style="height: 145px;">
            <?php if(is_array($goodData['pic'])): foreach($goodData['pic'] as $key=>$vp): ?><img src="/last/LastMission/project/Public/<?php echo ($vp["pic"]); ?>" alt="" width="100">&nbsp;<a href="javascript:;" style="position:relative;top:80px;left:-55px;" class="editdel">x</a>
        ...
        <script type="text/javascript">
        //ajax删除图片
          var url = "/last/LastMission/project/index.php/HMadmin/Goods/editDelPic";
