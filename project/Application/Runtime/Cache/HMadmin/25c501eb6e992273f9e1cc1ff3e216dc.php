...
<!-- admin-content part end -->
 ...
 <div class="admin-biaogelist">
      <div class="listbiaoti am-cf">
        ...
        <dl>
          <a href="/last/LastMission/project/index.php/HMadmin/AuthRule/showAddAuthPage" type="button" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus" data-am-modal="{target: '#my-popup'}">添加权限</a>
        </dl>
        <!--data-am-modal="{target: '#my-popup'}" 弹出层 ID  弹出层 190行 开始  271行结束--> 
        
      </div>
      <form action="/last/LastMission/project/index.php/HMadmin/AuthRule/deleteAuthAll" method="post" class="am-form am-g">
          ...
          <tbody>
            ...
            <?php if(is_array($authList)): foreach($authList as $key=>$v): ?><tr>
                  ...
                  <td><div class="am-btn-toolbar">
                     ...
                     <!--  <a href="/last/LastMission/project/index.php/HMadmin/AuthRule/" class="am-btn am-btn-default am-btn-xs am-text-success am-round am-icon-file" data-am-modal="{target: '#my-popups'}" title="添加子栏目"></a> -->
                        <a href="/last/LastMission/project/index.php/HMadmin/AuthRule/editAuth/id/<?php echo ($v["id"]); ?>" class="modifyBtn am-btn am-btn-default am-btn-xs am-text-secondary am-round"  title="修改"><span class="am-icon-pencil-square-o" ></span></a>             
                        <a href="/last/LastMission/project/index.php/HMadmin/AuthRule/deleteAuth/id/<?php echo ($v["id"]); ?>" class="deleteBtn am-btn am-btn-default am-btn-xs am-text-danger am-round"  title="删除"><span class="am-icon-trash-o"></span></a>
                      </div>
                    </div></td>
