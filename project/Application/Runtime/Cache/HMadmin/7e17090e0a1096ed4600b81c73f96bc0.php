                  	...
                  	<div>
                  		<div style="width: 480px;margin: 0 auto;">
                  			<li style="list-style: none;margin-bottom: 12px;overflow: hidden;">
                  				<div location="1" style="border: 1px solid black;width: 480px;height: 270px;line-hight:270px;text-align:center;font-size:150px">①
                          </div>
                  			</li>
                  			<li style="list-style: none;margin-bottom: 12px;overflow: hidden;">
	                  			<div location="2" style="border: 1px solid black;width: 234px;height: 351px;margin-right: 12px;float: left;text-align:center;font-size:150px;line-height:301px">②</div>
	                  			<div location="3" style="border: 1px solid black;width: 234px;height: 351px;float: left;text-align:center;font-size:150px;line-height:301px">③</div>
                  			</li>
                  			<li style="list-style: none;margin-bottom: 12px;overflow: hidden;">
	                  			<div location="4" style="border: 1px solid black;width: 152px;height: 228px;margin-right: 12px;float: left;text-align:center;font-size:150px;line-height:200px">④</div>
	                  			<div location="5" style="border: 1px solid black;width: 152px;height: 228px;margin-right: 12px;float: left;text-align:center;font-size:150px;line-height:200px">⑤</div>
	                  			<div location="6" style="border: 1px solid black;width: 152px;height: 228px;float: left;text-align:center;font-size:150px;line-height:200px">⑥</div>
                  			</li>
                  			<li style="list-style: none;margin-bottom: 12px;overflow: hidden;">
                  				<div location="7" style="border: 1px solid black;width: 480px;height: 320px;text-align:center;font-size:150px;">⑦</div>
                  			</li>
                  			<li style="list-style: none;margin-bottom: 12px;overflow: hidden;">
	                  			<div location="8" style="border: 1px solid black;width: 152px;height: 228px;margin-right: 12px;float: left;text-align:center;font-size:150px;line-height:200px">⑧</div>
	                  			<div location="9" style="border: 1px solid black;width: 152px;height: 228px;margin-right: 12px;float: left;text-align:center;font-size:150px;line-height:200px">⑨</div>
	                  			<div location="10" style="border: 1px solid black;width: 152px;height: 228px;float: left;text-align:center;font-size:150px;line-height:200px">⑩</div>
                  			</li>
                  			<li style="list-style: none;margin-bottom: 12px;overflow: hidden;">
                  				<div location="11" style="border: 1px solid black;width: 480px;height: 320px;text-align:center;font-size:150px;line-height:270px">⑪</div>
                  			</li>
...
<script>
	$('li>div').mouseover(function () {
		...
		location.href = '/2nd Project/04.21/project/index.php/HMadmin/IndexPic/indexPicList/location/' + $(this).attr('location');
	});
</script>
