...
<!-- admin-content part end -->
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl>
        <a href="/2nd Project/04.21/project/index.php/HMadmin/AuthGroup/showAddAuthGroupPage" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus" > 手动添加管理组</a>
      </dl>
      <!--这里打开的是新页面-->
    ...
    <form action="/2nd Project/04.21/project/index.php/HMadmin/AuthGroup/deleteAuthGroup" method="post" class="am-form am-g">
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <?php if(is_array($authGroupList)): foreach($authGroupList as $key=>$vo): ?><tr>
                ...
                <td><div style="overflow:auto;width:700px" ><?php echo ($vo["rules"]); ?></div></td>
                <td>
                	
                	
                	<div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <a href="/2nd Project/04.21/project/index.php/HMadmin/AuthGroup/authGroupDetail/id/<?php echo ($vo["id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-success am-round"><span class="am-icon-search" title="查看管理组详情"></span> </a>
                      <a href="/2nd Project/04.21/project/index.php/HMadmin/AuthGroup/editAuthGroup/id/<?php echo ($vo["id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-secondary am-round" data-am-modal="{target: '#my-popups'}" title="修改管理组"><span class="am-icon-pencil-square-o"></span></a>
                      <a href="/2nd Project/04.21/project/index.php/HMadmin/AuthGroup/deleteAuthGroupOne/id/<?php echo ($vo[id]); ?>" class="deleteBtn am-btn am-btn-default am-btn-xs am-text-danger am-round"  title="删除组"><span class="am-icon-trash-o"></span></a>
                    </div>
                  </div>
