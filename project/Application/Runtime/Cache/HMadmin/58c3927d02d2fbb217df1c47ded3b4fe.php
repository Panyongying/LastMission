...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      <ul class="am-icon-flag on"> 栏目名称 &nbsp;<span id="spanSize"></span></ul>
    ...
    <div class="fbneirong">
      <form class="Forms am-form" action="/last/LastMission/project/index.php/HMadmin/Goods/addGood" method="post">
        ...
        <div class="am-form-group am-cf">
          ...
          <div class="you">
            <select name="tid">
            <?php if(is_array($type)): foreach($type as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"
              <?php if($vo["pid"] == 0): ?>disabled  /><?php echo ($vo["name"]); ?></option>
                <?php else: ?>  />----<?php echo ($vo["name"]); ?></option><?php endif; endforeach; endif; ?>
            </select>
          </div>
        </div>
        ...
        <script>
          ...
          $(".dropzone").dropzone({
            ...
            url:"/last/LastMission/project/index.php/HMadmin/Goods/upload/",
            ...
            init: function() {
              ...
              this.on("removedfile", function(file) {
                ...
                $.ajax({
                  ...
                  url: "/last/LastMission/project/index.php/HMadmin/Goods/deletePic",
                  type: "post",
          ...
          //验证用户输入信息
          $('.fbneirong input').blur(function() {

            if ($(this).val() == '') {

              $('#spanSize').css('color', 'red').html('请输出商品名');
