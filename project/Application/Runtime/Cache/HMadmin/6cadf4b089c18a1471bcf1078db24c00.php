          ...
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
            ...
            <tbody>
              <?php if(is_array($list)): foreach($list as $key=>$ov): ?><tr>
                  ...
                  <td><img src="/2nd Project/04.21/project/Public<?php echo ($ov["pic"]); ?>" alt="" height="50"></td>
...
<script>
  $('.mo-btn').click(function () {
    ...
    location.href = "/2nd Project/04.21/project/index.php/HMadmin/IndexPic/editIndexPic/id/" + pid;
  ...
  $('.rm-btn').click(function () {
    ...
    if (bool) {
      $.get(
        '/2nd Project/04.21/project/index.php/HMadmin/IndexPic/deleteIndexPic',
        {id:id},
        function (data) {
          if (data == 1) {
  ...
  $('#deleteSelect').click(function () {
    ...
    if (bool) {
      ...
      $.post(
        '/2nd Project/04.21/project/index.php/HMadmin/IndexPic/multipleDelete',
        {ids:ids},
        function (data) {
          if (data == 1) {
