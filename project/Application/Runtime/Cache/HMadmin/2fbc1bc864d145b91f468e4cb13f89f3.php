...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
	...
	<title>后台首页</title>
  <script src="/2nd Project/04.21/project/Public/jscharts.js"></script>
...
<div class="admin">
   ...
   <div class="admin-index">
      ...
      <dl data-am-scrollspy="{animation: 'slide-right', delay: 300}">
        <dt class="cs"><i class="am-icon-area-chart"></i></dt>
        <dd><?php echo ($todayUserNum); ?></dd>
        <dd class="f12">今日会员</dd>
      </dl>
      <dl data-am-scrollspy="{animation: 'slide-right', delay: 900}">
        <dt class="ls"><i class="am-icon-cny"></i></dt>
        <dd><?php echo ($todayOrderNum); ?></dd>
        <dd class="f12">今日订单</dd>
      </dl>
      <dl data-am-scrollspy="{animation: 'slide-right', delay: 900}">
      <a href="/2nd Project/04.21/project/index.php/HMadmin/Index/todayPrice">
        <dt class="ls"><i class="am-icon-cny"></i></dt>
        <dd style="font-size: 16px">￥<?php echo ($todayPrice); ?></dd>
        <dd class="f12">今日收入</dd>
      </a>
      </dl>
      <dl data-am-scrollspy="{animation: 'slide-right', delay: 900}">
      <a href="/2nd Project/04.21/project/index.php/HMadmin/Index/allPrice">
        <dt class="ls"><i class="am-icon-cny"></i></dt>
        <dd style="font-size: 16px">￥<?php echo ($allPrice); ?></dd>
        <dd class="f12">总&nbsp;&nbsp;收&nbsp;&nbsp;入</dd>
      </a>
      </dl>
    </div>
...
<script type="text/javascript">
  var myData = JSON.parse('<?php echo ($pieData); ?>');
  // var colors = ['#0673B8', '#0091F1', '#F85900'];
  var colors = [];
  for (i in JSON.parse('<?php echo ($pieData); ?>')) {
    colors.unshift('#'+Math.floor(Math.random(6)*1000000));
  }
  var myChart = new JSChart('graph', 'pie');
  myChart.setDataArray(myData);
  myChart.colorizePie(colors);
  myChart.setTitle('管理员部门人数占比 (%)');
