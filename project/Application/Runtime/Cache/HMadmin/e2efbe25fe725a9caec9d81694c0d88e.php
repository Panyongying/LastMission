...
<!-- admin-content part end -->
 ...
 <div class="admin-biaogelist">
      <div class="listbiaoti am-cf">
        ...
        <!-- <dl>
          <a href="/last/LastMission/project/index.php/HMadmin/XunSearch/showAddType" type="button" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus" data-am-modal="{target: '#my-popup'}">添加商品一级分类</a>
        </dl> -->
        ...
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
          ...
          <tbody>
            ...
            $('.dBtn').on('click', function() {
              ...
              $.ajax({
                url:'/last/LastMission/project/index.php/HMadmin/XunSearch/' + name,
