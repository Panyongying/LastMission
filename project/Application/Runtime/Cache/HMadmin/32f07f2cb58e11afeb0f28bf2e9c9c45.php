...
<div class="admin-biaogelist">
    ...
    <form action="/2nd Project/04.21/project/index.php/HMadmin/Order/index" method="get">
  <ul>
    <li>
...
<script>
  $('.de-btn').click(function () {
    ...
    location.href = '/2nd Project/04.21/project/index.php/HMadmin/OrderDetail/getOrderDetail/oid/' + oid;
  ...
  $('.mo-btn').click(function () {
    ...
    location.href = '/2nd Project/04.21/project/index.php/HMadmin/Order/editOrder/id/' + oid;
  ...
  $('.rm-btn').click(function () {
    ...
    if (bool) {
      ...
      $.get(
        ...
        '/2nd Project/04.21/project/index.php/HMadmin/Order/deleteOrder',
        {id:id},
        function (data) {
          console.log(data);
          if (data == 1) {
  ...
  $('#deleteSelect').click(function () {
    ...
    if (bool) {
      ...
      $.post(
        '/2nd Project/04.21/project/index.php/HMadmin/Order/multipleDelete',
        {
          ids:ids
        },
        function (data) {
  ...
  $('.se-btn').click(function () {
    ...
    $.get(
        '/2nd Project/04.21/project/index.php/HMadmin/Order/send',
        {
          id:$(this).attr('oid')
        },
        function (data) {
          if (data == 1) {
            that.parent().parent().parent().prev().prev().html('配送中');
            that.remove();
          } else {
            alter('操作失败，请稍后再试。');
          }
