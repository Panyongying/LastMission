...
<div class="admin-biaogelist">
    ...
    <form action="/last/LastMission/project/index.php/HMadmin/Order/index" method="get">
  <ul>
    <li>
              ...
              <?php if(is_array($list)): foreach($list as $key=>$ov): ?><tr>
                  ...
                  <td>
                      ...
                      <div class="am-btn-group am-btn-group-xs">
                        ...
                        <?php if(($ov["orderstatus"] == '已付款') AND ($ov["ordersendstatus"] == '等待配送')): ?><button class="am-btn am-btn-default am-btn-xs am-text-secondary am-round" title="发货"><span class="am-icon-plane"></span></button><?php endif; ?>
...
<script>
  $('.de-btn').click(function () {
    ...
    location.href = '/last/LastMission/project/index.php/HMadmin/OrderDetail/getOrderDetail/oid/' + oid;
  ...
  $('.mo-btn').click(function () {
    ...
    location.href = '/last/LastMission/project/index.php/HMadmin/Order/editOrder/id/' + oid;
  ...
  $('.rm-btn').click(function () {
    ...
    if (bool) {
      ...
      $.get(
        ...
        '/last/LastMission/project/index.php/HMadmin/Order/deleteOrder',
        {id:id},
        function (data) {
          console.log(data);
          if (data == 1) {
  ...
  $('#deleteSelect').click(function () {
    ...
    if (bool) {
      ...
      $.post(
        '/last/LastMission/project/index.php/HMadmin/Order/multipleDelete',
        {ids:ids},
        function (data) {
          if (data == 1) {
