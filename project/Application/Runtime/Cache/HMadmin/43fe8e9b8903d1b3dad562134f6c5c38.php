...
<div class="admin-biaogelist">
    ...
    <form action="/2nd Project/04.21/project/index.php/HMadmin/Commentary/index" method="get">
  <ul>
...
<script>
  $('.rm-btn').click(function () {
    ...
    if (bool) {
      $.get(
        '/2nd Project/04.21/project/index.php/HMadmin/Commentary/deleteCommentary',
        {id:id},
        function (data) {
          if (data == 1) {
  ...
  $('#deleteSelect').click(function () {
    ...
    if (bool) {
      ...
      $.post(
        '/2nd Project/04.21/project/index.php/HMadmin/Commentary/multipleDelete',
        {ids:ids},
        function (data) {
          if (data == 1) {
