...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      <ul class="am-icon-flag on"> 添加友链</ul>
      
      <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="#">添加友链</a></dl>
    ...
    <div class="fbneirong">
      <form class="am-form" action="" method="post">
        <div class="am-form-group am-cf">
          ...
          <div class="you">
            <input type="text" class="am-input-sm" id="doc-ipt-email-1" name="name" placeholder="请输入名字">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">URL：</div>
          <div class="you">
            <input type="url" class="am-input-sm" id="doc-ipt-pwd-1" name="url" placeholder="请输入URL">
          </div>
        </div>
        <div class="am-form-group am-cf">
