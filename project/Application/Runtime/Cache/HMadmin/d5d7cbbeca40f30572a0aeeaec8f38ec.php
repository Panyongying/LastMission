...
<script>
  $('.add-btn').click(function () {
    location.href = "/2nd Project/04.21/project/index.php/HMadmin/Links/addLinks";
  ...
  $('.mo-btn').click(function () {
    ...
    location.href = "/2nd Project/04.21/project/index.php/HMadmin/Links/editLinks/id/" + lid;
  ...
  $('.rm-btn').click(function () {
    ...
    if (bool) {
      ...
      $.get(
        ...
        '/2nd Project/04.21/project/index.php/HMadmin/Links/deleteLinks',
        {id:id},
        function (data) {
          if (data == 1) {
  ...
  $('#deleteSelect').click(function () {
    ...
    if (bool) {
      ...
      $.post(
        '/2nd Project/04.21/project/index.php/HMadmin/Links/multipleDelete',
        {ids:ids},
        function (data) {
          if (data == 1) {
