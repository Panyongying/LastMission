...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl>
        <a href="/last/LastMission/project/index.php/HMadmin/Goods/addGood"><button type="button" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus"> 添加产品</button></a>
      </dl>
  ...
  <ul>
    ...
    <form action="/last/LastMission/project/index.php/HMadmin/Goods/index" method="get">
    ...
    <form class="am-form am-g" action="/last/LastMission/project/index.php/HMadmin/Goods/deleteAll" method="post">
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <?php if(is_array($goodsList)): foreach($goodsList as $k=>$vo): ?><tr>
                ...
                <td><a href="/last/LastMission/project/index.php/HMadmin/Goods/stockDeatil/gid/<?php echo ($vo["id"]); ?>">库存详情</a></td>
                ...
                <td><a href="/last/LastMission/project/index.php/HMadmin/Goods/goodsDetail/id/<?php echo ($vo["id"]); ?>">详情图</a></td>
                ...
                <td><div class="am-btn-toolbar" data-num="<?php echo ($k); ?>">
                    <div class="am-btn-group am-btn-group-xs">
                      <a href="/last/LastMission/project/index.php/HMadmin/Goods/goodsEdit/id/<?php echo ($vo["id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-secondary am-round"><span class="am-icon-pencil-square-o"></span></a>
              ...
              <button type="button" class="am-btn am-btn-default"><span class="am-icon-plus" style="color:lime"><a href="/last/LastMission/project/index.php/HMadmin/Goods/addGood" style="color:lime"> 新增</a></span></button>
          ...
          <ul class="am-pagination am-fr">
            ...
            // ajax删除
              ...
              $('.del').on('click', function () {
                ...
                var url = '/last/LastMission/project/index.php/HMadmin/Goods/ajaxDelete';
            ...
            //ajax修改状态
              ...
              $('.goodtr').on('click', function() {
                ...
                var url = '/last/LastMission/project/index.php/HMadmin/Goods/editStatus';
